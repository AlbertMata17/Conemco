...
<div class="row">
    ...
    <div class="col-md-3">
        	<div class="project-header">
            	<h2><?php echo $lang['View Project']; ?> </h2>
			</div>
...
<div class="col-md-8">
			<div class="form-group">
			 <div class="field-label"><label for="firstName"><?php echo $lang['Project Titles*']; ?></label></div>
				<input type="text" readonly name="projectTite" class="form-control" value="<?php echo $project_title; ?>" required>
			</div>
			<div class="form-group">
			<div class="field-label"><label for="firstName"><?php echo $lang['Description']; ?></label></div>
				<textarea readonly class="form-control" name="description"><?php echo $project_desc;?></textarea>
			</div>
<div class="row">
<div class="col-md-6">
<div class="form-group">
<div class="field-label"><label for="firstName"><?php echo $lang['Budget*']; ?></label></div>
	<input type="number" readonly name="budget" placeholder="<?php echo $currency_symbol . $recentProject->budget;?>" class="form-control" value="<?php echo $budget;?>" required>
	<input type="hidden" readonly name="status" value="<?php echo $status;?>" >
	<input type="hidden" readonly name="archive" value="<?php echo $archive;?>" >
</div>
<div class="form-group">
<div class="field-label"><label for="firstName"><?php echo $lang['Start Date*']; ?></label></div>
	<input type="text" readonly name="startTime" placeholder="Start Time" class="form-control" value="<?php echo $start_time;?>" required />
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<div class="field-label"><label for="firstName"><?php echo $lang['Client']; ?></label></div>
...
<div class="field-label"><label for="firstName"><?php echo $lang['End Date*']; ?></label></div>
	<input readonly type="text" name="endTime" placeholder="<?php echo $lang['End Time']; ?>" class="form-control" value="<?php echo $end_time;?>"  required />
</div>				
</div>

<div class="col-md-6">
<div class="form-group">
<div class="field-label"><label for="idstatus"><?php echo $lang['status']; ?></label></div>
<select disabled class="form-control" name="idstatus">
...
<div class="col-md-6">
<div class="form-group">
<div class="field-label"><label for="idtype"><?php echo $lang['type']; ?></label></div>
<select disabled class="form-control" name="idtype">
...
<div class="col-md-6">
<div class="form-group">
<input type="text" value="<?php echo $porcentaje_avance?>" placeholder="<?php echo $lang["percentage of completion"] ?>" name="porcentaje_avance" class="form-control"/>
...
<select disabled multiple class="form-control" name="staff[]">
	<?php 
			foreach($recentlyRegisteredUsers as $recentlyRegisteredUser){ 
				if($recentlyRegisteredUser->accountStatus ==3){
					?>
...
<div class="col-md-6">
<div class="form-group">
	<input readonly type="number" name="quoted_hour" value="<?php echo $quoted_hour?>" placeholder="<?php echo $lang['quote hour']; ?>" class="form-control">

</div>
<div class="form-group">
<input readonly type="number" name="quoted_price" value="<?php echo $quoted_price?>" placeholder="<?php echo $lang['quote price']; ?>" class="form-control">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<input readonly type="number" name="ocurrence_probability" value="<?php echo $ocurrence_probability?>" placeholder="<?php echo $lang['performance probabilities']; ?>" class="form-control">
...
<input readonly type="hidden" value="<?php echo $pro_id_u;?>" name="p_id"/>
<input readonly type="submit" name="back-project" value="<?php echo $lang['back']; ?>"  class="btn new-btnblue"/>
</div>
</div>
</div>			
</div> 
