...
$account_stat=$user->status;
	$pro_id =  $_POST['idtype'];
if($pro_id == ""){
	header("Location:categories_agenda.php");
}
...
$sql_up = "UPDATE `categories_diary` SET
`name`='$pp_title',
`description`='$pp_desc',
`status`='$p_status',
...
header("Location:categories_agenda.php?message=success");
				} else {
...
<?php 
$qur_pro = Type_Diary::findBySql("select * from categories_diary where idtype = '$pro_id'");
