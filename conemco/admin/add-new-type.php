...
header("Location:type_projects.php?message=created");
				  }
				  else
				  {
...
<div class="row">
    <div class="col-md-3">
        	<div class="project-header">
				...
				<p><?php echo $lang['create a new type for your project here.']; ?></p>
			</div>
...
<div class="form-group">
	<input type="text" id="nombre" name="typeTite" class="form-control" placeholder="<?php echo $lang['type title']; ?>" required>
</div>
<div class="form-group">
