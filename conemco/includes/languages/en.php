...
//para traducir
"Create Status"=>"Create Status",
"There is no timesheet Please Create timesheet!"=>"There is no timesheet Please Create timesheet!",
"Company"=>"Company",
"All company deleted"=>"All company deleted",
"View Project"=>"View Project",
"Project Titles*"=>"Project Titles*",
"status"=>"status",
"type"=>"type",
"back"=>"back",
"All Status leads"=>"All Status leads",
"Select a proyect"=>"Select a proyect",
"Select a task"=>"Select a task",
"Worked Hour"=>"Worked Hour",
"Finish Task"=>"Finish Task",
"use this option to mark as completed task"=>"use this option to mark as completed task",
"Search Status"=>"Search Status",
"Search company"=>"Search company",
"Manage Status"=>"Manage Status",
"All Status deleted"=>"All Status deleted",
"Are your sure you want to <br> permanently delete this timesheet"=>"Are your sure you want to <br> permanently delete this timesheet",
...
"All company leads"=>"All company leads",
"Client has been created successfully!"=>"Client has been created successfully!",
"Client has been deleted sucessfully"=>"Client has been deleted sucessfully",
"Client status updated to re-open."=>"Client status updated to re-open.",
"Client restored Successfully."=>"Client restored Successfully.",
"Manage client"=>"Manage client",
"All client leads"=>"All client leads",
...
"Deleting Project will aslo  delete all data. <br>milestone, payment record."=>"Deleting Project will aslo  delete all data. <br>milestone, payment record.",

"Are your sure you want to <br> permanently delete this project"=>"Are your sure you want to <br> permanently delete this project",

"There is no client Please Create client!"=>"There is no client Please Create client!",
"Client could not created at this time. Please Try Again Later . Thanks"=>"Client could not created at this time. Please Try Again Later . Thanks",

"View All contacts"=>"View All contacts",
"Categories"=>"Categories",
"diary"=>"diary",
"Manage type diary"=>"Manage type diary",
"Search type diary"=>"Search type diary",
"create a new type for your client here."=>"create a new type for your client here.",
"title diary"=>"title diaryNombre del tipo de cliente",
"Company"=>"Company",
...
"Date"=>"Date",
"Write a status description here"=>"Write a status description here",
"Write a type description here"=>"Write a type description here",
"Update Status"=>"Update Status",
"Update type"=>"Update type",
"Edit Status"=>"Edit Status",
"Edit type"=>"Edit type",
"Type"=>"Type",
"All type deleted"=>"All type deleted",
"All client deleted"=>"All client deleted",
"Categories"=>"Categories",
"Deleting this record will also  delete all data."=>"Deleting this record will also  delete all data.",
"type project"=>"type project",
"type has been deleted sucessfully"=>"type has been deleted sucessfully",
"type status updated to re-open."=>"type status updated to re-open.",
"type restored Successfully."=>"type restored Successfully.",
"Manage type"=>"Manage typeGestionar Tipos de Proyectos",
"All type leads"=>"All type leads",
"Select a type"=>"Select a type",
"quote data"=>"quote data",
"quote price"=>"quote price",
"quote hour"=>"quote hour",
"performance probabilities"=>"performance probabilities",
"Choose any data qoute for this project"=>"Choose any data qoute for this project",
...
"There is no type Please Create type!"=>"There is no type Please Create type!",
"Edit type"=>"Edit type",
"Search type"=>"Search type",
"type has been created successfully!"=>"type has been created successfully!",
"company has been created successfully!"=>"company has been created successfully!",
"company has been deleted sucessfully"=>"company has been deleted sucessfully",
"company status updated to re-open."=>"company status updated to re-open.",
...
"All timesheet leads"=>"All timesheet leads",
"Search timesheet"=>"Search timesheet",
"Create Timesheet"=>"Create Timesheet",
"timesheet has been deleted sucessfully"=>"timesheet has been deleted sucessfully",
"timesheet marked as Completed."=>"timesheet marked as Completed.",
"Edit timesheet"=>"Edit timesheet",
"timesheet"=>"timesheet",
"All timesheet deleted"=>"All timesheet deleted",

"timesheet status updated to re-open."=>"timesheet status updated to re-open.",
"timesheet restored Successfully."=>"timesheet restored Successfully.",
"timesheet restored Successfully."=>"timesheet restored Successfully.",
"timesheet has been created successfully!"=>"timesheet has been created successfully!",
"timesheet could not created at this time. Please Try Again Later . Thanks"=>"Timesheet no pudo ser creada en estos momentos. por favor intenta de nuevo mas tarde. Graciastimesheet could not created at this time. Please Try Again Later . Thanks",
"type has been created successfully! but Error sending the Email please contact site administrator."=>"type has been created successfully! but Error sending the Email please contact site administrator.",

"There is no Status Please Create Status!"=>"There is no Status Please Create Status!",
"Add New Status"=>"Add New Status",
"Add New type"=>"Add New type",
"Create New Status"=>"Create New Status",
"Create New type"=>"Create New type",
"create a new status for your project here."=>"create a new status for your project here.",
"create a new timesheet for your project here."=>"create a new timesheet for your project here.",
"create a new type for your project here."=>"create a new type for your project here.",
"Status title"=>"Status title",
"type title"=>"type title",
"Notify to client and staff status has been Updated"=>"Notify to client and staff status has been Updated",
"Notify to client and staff type has been Updated"=>"Notify to client and staff type has been Updated",
"Notify to client and staff status has been created"=>"Notify to client and staff status has been created",
"Notify to client and staff type has been created"=>"Notify to client and staff type has been created",
"Status has been created successfully!"=>"Status has been created successfully!",
"type has been created successfully!"=>"type has been created successfully!",
"New Status Created"=>"New Status Created",
"New Status Created"=>"New Status Created",
"Edit Timesheet"=>"Edit Timesheet",
"created by"=>"created by",
"Edit timesheet for your project here."=>"Edit timesheet for your project here.",
"New type Created"=>"New type Created",
"Status has been deleted sucessfully"=>"Status has been deleted sucessfully",
"Status status updated to re-open."=>"Status status updated to re-open.",
"Status restored Successfully."=>"Status restored Successfully.",
"Are your sure you want to <br> permanently delete this Record"=>"Are your sure you want to <br> permanently delete this Record",
"Status has been created successfully! but Error sending the Email please contact site administrator"=>"Status has been created successfully! but Error sending the Email please contact site administrator",
"type has been created successfully! but Error sending the Email please contact site administrator"=>"type has been created successfully! but Error sending the Email please contact site administrator",
"Status could not created at this time. Please Try Again Later . Thanks!"=>"Status could not created at this time. Please Try Again Later . Thanks!",
"company could not created at this time. Please Try Again Later . Thanks!"=>"company could not created at this time. Please Try Again Later . Thanks!",
"type could not created at this time. Please Try Again Later . Thanks!"=>"type could not created at this time. Please Try Again Later . Thanks!",
